...
export class LocationStateComponent {
  readonly message = input<string>('We need your location to continue. Please enable location services and try again.');
  readonly helpText = input<string>('Check your browser settings to allow location access for this site.');
