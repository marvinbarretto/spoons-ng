  ...
  template: `
    ...
    <div class="demo-container">
      <div class="demo-content">
        ...
        <p>A very subtle animated background using pub carpet images. Perfect for ambient page backgrounds.</p>
        ...
        <div class="usage-info">
          ...
          <ul>
            <li><strong>Automatic optimizations:</strong> Disables on low battery, reduced motion, or poor performance</li>
            <li><strong>Carpet transitions:</strong> Tiles randomly switch between pub carpet images every 30-120 seconds</li>
            <li><strong>Responsive:</strong> Adjusts tile count and size based on device capabilities</li>
            <li><strong>Configurable:</strong> Settings persist in localStorage</li>
          </ul>
          
          <p><strong>To use globally:</strong> Add <code>&lt;app-background-carpet&gt;&lt;/app-background-carpet&gt;</code> to your app root component.</p>
        </div>
      </div>
    </div>
  `,
