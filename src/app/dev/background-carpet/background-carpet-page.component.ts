  ...
  template: `
    ...
    <div class="controls-overlay" [class.collapsed]="isCollapsed()">
      <div class="controls-header">
        ...
        <app-button variant="outline" size="xs" (click)="toggleCollapsed()">
          {{ isCollapsed() ? '▲' : '▼' }}
        </app-button>
      </div>
    ...
    <div class="content-area">
      <div class="content-card">
        ...
        <p class="lead">
          Experience the gentle, ambient carpet background animation designed for pub-themed
          applications.
        </p>
        ...
        <div class="feature-grid">
          <div class="feature-card">
            <h3>🎯 Subtle Design</h3>
            <p>
              Very low opacity (15% default) ensures it never interferes with content readability
          ...
          <div class="feature-card">
            ...
            <p>
              Uses requestIdleCallback, visibility detection, and smart throttling to maintain <1%
              CPU usage.
            </p>
          </div>
          ...
          <div class="feature-card">
            ...
            <p>
              Adjust opacity, animation speed, tile size, and performance settings. All preferences
          ...
          <div class="feature-card">
            ...
            <p>
              Uses real pub carpet images from your collection: Bangor, John Jaques, Moon Under
              Water, and Red Lion.
            </p>
          </div>
          ...
          <div class="feature-card">
            <h3>📱 Responsive</h3>
            <p>
              Automatically adjusts tile count and size based on device capabilities and user
              preferences.
            </p>
          </div>
          ...
          <div class="feature-card">
            <h3>♿ Accessible</h3>
            <p>
              Respects reduced motion preferences and automatically disables on low battery or poor
              performance.
            </p>
          </div>
        </div>
        ...
        <div class="implementation-info">
          ...
          <p>
            The component will automatically handle all performance optimizations and user
            preferences.
          </p>
        </div>
        ...
        <div class="sample-content">
          ...
          <p>
            ...
            impacting readability. The animation is intentionally very slow and gentle - you might
            see a tile change every 30-120 seconds.
          </p>
          ...
          <p>
            The background system automatically cycles between these carpet images, creating an
            organic, ever-changing subtle texture that enhances the pub atmosphere of your
            application.
          </p>
        </div>
      </div>
...
export class BackgroundCarpetPageComponent extends BaseComponent {
  ...
  updatePerformance(event: Event): void {
    const target = event.target as HTMLSelectElement;
    this.backgroundService.setPerformanceMode(target.value as 'low' | 'medium' | 'high');
  }
