      ...
      <header class="showcase__header">
        <div class="showcase__header-content">
          ...
          <div class="showcase__actions">
            <app-button variant="ghost" size="sm" (onClick)="toggleTheme()">
              ...
              <div class="workspace-grid">
                  ...
                  >
                    <div class="component-wrapper">
                      @switch (activeComponent()) {
                        ...
                        @case ('LoadingState') {
                          <ff-loading-state [text]="currentProps()['text']"> </ff-loading-state>
                        }
                        @case ('ErrorState') {
                          <ff-error-state
                        ...
                        @default {
                          <div class="component-placeholder">
                            ...
                            <small
                              >Direct component rendering not yet implemented for this
                              component.</small
                            >
                          </div>
                        }
                ...
                <section class="controls-section">
                  ...
                  <div class="controls-actions">
                    <button type="button" class="reset-all-button" (click)="resetAllProps()">
