...
describe('BadgesWidgetComponent', () => {
  ...
  const mockBadges: Badge[] = [
    { id: '1', name: 'First Check-in', description: 'Check into your first pub', iconUrl: '', points: 10 },
    { id: '2', name: 'Explorer', description: 'Check into 5 different pubs', iconUrl: '', points: 25 }
  ];
